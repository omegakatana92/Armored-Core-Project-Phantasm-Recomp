...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Armored Core: Project Phantasma",
    .project_root_env = "ARMOREDCOREPROJECTPHANTASMARECOMP_PROJECT_ROOT",
    .build_dir_env = "ARMOREDCOREPROJECTPHANTASMARECOMP_BUILD_DIR",
    .force_setup_env = "ARMOREDCOREPROJECTPHANTASMARECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_006.70_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Armored_Core__Project_Phantasma_Recompiled",
    .prepare_note =
